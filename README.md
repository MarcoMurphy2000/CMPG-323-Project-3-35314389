...
After running the project or opening the link to the project hosted on Azure, you can register by clicking on the register button. You will be prompted to register with your email and a strong password. You can also choose weather or not to be remembered to make the logging in prcocess much quicker. <br />
After registering you should automatically be logged. From this page you will see the home, Zones, Categories, Devices, and Logout buttons. <br />
After clicking on one of the 3 controller buttons (either Zones, Categories, or Devices) you will see all existing records for that controller.<br />
